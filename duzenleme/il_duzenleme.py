...
##################################Sayisal#################################
    ...
    cursor.execute("Select yeni_mezun,onceki_mezun From sayisal_2021 Where lise_il =? ",(lise_il,))
    data = cursor.fetchall() 
    ...
    cursor.execute("Select yeni_mezun,onceki_mezun From esit_2021 Where lise_il =? ",(lise_il,))
    data = cursor.fetchall() 
    ...
    cursor.execute("Select yeni_mezun,onceki_mezun From sozel_2021 Where lise_il =? ",(lise_il,))
    data = cursor.fetchall() 
    ...
    cursor.execute("Select yeni_mezun,onceki_mezun From dil_2021 Where lise_il =? ",(lise_il,))
    data = cursor.fetchall() 
    ...
    cursor.execute("Select yeni_mezun,onceki_mezun From onlisans_2021 Where lise_il =? ",(lise_il,))
    data = cursor.fetchall() 
    ...
    cursor.execute("Select * From il_sayilar_tablo Where il_id =? ",(lise_il,))
    data = cursor.fetchall() 
    veri=data[0]
    deger_ekle_il_tablo(veri[0],sayisal_2021_sayi_yeni,sayisal_2021_sayi_eski,veri[1],veri[2],veri[3],veri[4],veri[5],veri[6],esit_2021_sayi_yeni,esit_2021_sayi_eski,veri[7],veri[8],veri[9],veri[10],veri[11],veri[12],sozel_2021_sayi_yeni,sozel_2021_sayi_eski,veri[13],veri[14],veri[15],veri[16],veri[17],veri[18],dil_2021_sayi_yeni,dil_2021_sayi_eski,veri[19],veri[20],veri[21],veri[22],veri[23],veri[24],onlisans_2021_sayi_yeni,onlisans_2021_sayi_eski,veri[25],veri[26],veri[27],veri[28],veri[29],veri[30])
